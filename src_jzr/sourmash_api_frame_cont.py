...
ref_input='/data/jzr5814/data/uniprotkb.fasta'
scaled=1
ref_output='/data/jzr5814/data/uniprotkb_scaled1.sig'
cmd2=f"sourmash sketch protein -p {ref_input} k=7,k=14,k=21,k=28,k=35,k=42,k=49,k=56,k=63,k=70,scaled={scaled} -o {ref_output}"
print(cmd2)
subprocess.run(cmd2, stdout=subprocess.PIPE, shell=True)

#output containment csv file
query_file = '/data/jzr5814/data/frame_analysis_using_bash_script/query_frames.sig.zip'
ref_file = '/data/jzr5814/data/uniprotkb_scaled1.sig'

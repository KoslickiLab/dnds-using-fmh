...
ref_output=../../data/test3/50_sequences.sig
samp_output=../../data/test3/5_uniprot_seqs.sig.zip
ref_scaled=100
samp_scaled=1
tbp=1
wd=../../data/test3/
...
nohup sourmash sketch protein -p k=7,k=14,k=21,k=28,scaled=$samp_scaled $samples --singleton -o $samp_output > test_sketch_sample.txt 2>&1 &

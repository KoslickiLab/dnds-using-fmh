...
plot_title = f"Distribution of FMH dNdS between positive and negative selection (p rate={p}, len=10002, k={ksize})"
...
plt.figure.savefig(f'{wd}/{ksize}_selection_dist.png',bbox_inches='tight')

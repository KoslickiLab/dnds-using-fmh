...
wd1='/data/jzr5814/sourmash_dnds_estimation/tests/test/create_sequence_using_NG_assumption/0.001/fmh_dnds_sketch_protein/positive_selection'
file1 = f'{wd1}/dnds_constant_all_fixed_columns.csv'
...
wd2='/data/jzr5814/sourmash_dnds_estimation/tests/test/create_sequence_using_NG_assumption/0.001/fmh_dnds_sketch_protein/negative_selection'
file2 = f'{wd1}/dnds_constant_all_fixed_columns.csv'
...
heatmap1 = sns.heatmap(file2, ax=axes[0], annot=False,fmt='.4f',annot_kws={"size": 7}
                ,yticklabels=False, vmin=0.94,cmap='Blues',
                cbar_kws={'label': 'Sequence Relatedness'},cbar=False)
axes[0].set_title('Negative')

# Plot the first heatmap
heatmap2 = sns.heatmap(file1, ax=axes[1], annot=False,fmt='.4f',annot_kws={"size": 7}
                ,yticklabels=False, vmin=0.94,cmap='Blues',
                cbar_kws={'label': 'Sequence Relatedness'}, cbar=False)
...
fig.text(0.5, 0.03, 'Approximations from FMH Containment', ha='center', va='center')
# Adjust layout
#plt.tight_layout()
...
fig.figure.savefig(f"/data/jzr5814/sourmash_dnds_estimation/thesis_figures/approx_ANI_and_AAI_heatmaps.png",bbox_inches='tight') 
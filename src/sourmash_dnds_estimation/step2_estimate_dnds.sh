...
nt_compare_wd='/data/jzr5814/sourmash_dnds_estimation/tests/results/sourmash_compare_ground_truth/sourmash_compare_nt/' #DNA compare
prot_compare_wd='/data/jzr5814/sourmash_dnds_estimation/tests/results/sourmash_compare_ground_truth/sourmash_compare_protein/' #protein/translate compare

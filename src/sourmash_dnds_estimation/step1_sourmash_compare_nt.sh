...
data=/data/jzr5814/sourmash_dnds_estimation/tests/results/dnds_ground_truth/HIT000324409_pairwise_take_2_with_CDS_transcripts/
#data=$1
sigs=${data}
...
mkdir ${wd}
#fasta files
ref=${data}pairwise_HIT000324409.fastn
samples=${data}pairwise_HIT000324409.fastn
...
sourmash sketch dna -p k=15,k=18,k=21,k=24,k=27,k=30,k=33,k=36,k=39,k=42,k=45,k=60,k=75,k=90,scaled=$ref_scaled $ref --singleton -o $ref_output

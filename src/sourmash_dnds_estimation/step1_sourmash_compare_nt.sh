...
sourmash sketch dna -p k=15,k=18,k=21,k=24,k=27,k=30,k=45,k=60,k=75,k=90,scaled=$ref_scaled $ref -o $ref_output

#sourmash sketch dna -p k=21,scaled=$samp_scaled $samples --singleton -o $samp_output
sourmash sketch dna -p k=15,k=18,k=21,k=24,k=27,k=30,k=45,k=60,k=75,k=90,scaled=$samp_scaled $samples --singleton -o $samp_output


for K in 15 18 21 24 27 30 45 60 75 90
do

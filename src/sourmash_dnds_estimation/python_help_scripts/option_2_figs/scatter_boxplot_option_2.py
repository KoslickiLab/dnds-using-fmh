...
medians_df = medians_df.append(above1_medians)
medians_df = medians_df.append(above1_means)
medians_df = medians_df.append(above1_maxs)
medians_df = medians_df.append(above1_mins)

medians_df = medians_df.append(below1_medians)
medians_df = medians_df.append(below1_means)
medians_df = medians_df.append(below1_maxs)
medians_df = medians_df.append(below1_mins)

...
"""SKETCH FILES"""
def sketch_genome_dna(fasta, klist, scaled, out_sigfile):
...
def sketch_genome_protein(fasta, klist, scaled, out_sigfile):
    """sketch a protein fasta file. Used when a fasta include genomic information of one species
    fasta: Fasta input file
    klist: list of k-mer sizes
    scaled: scaled factor
    outfile: signature name"""
